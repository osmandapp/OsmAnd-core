...
LOCAL_SRC_FILES := \
	...
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrAAConvexPathRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrAADistanceFieldPathRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrAAHairLinePathRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrAARectRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrAddPathRenderers_default.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrAtlas.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrBitmapTextContext.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrBlend.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrBufferAllocPool.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrCacheID.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrClipData.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrClipMaskCache.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrClipMaskManager.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrContext.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrContextFactory.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrCoordTransform.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrDefaultGeoProcFactory.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrDefaultPathRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrDistanceFieldTextContext.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrDrawState.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrDrawTarget.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrFlushToGpuDrawTarget.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrFontCache.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrFontScaler.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrGeometryProcessor.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrGpu.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrGpuFactory.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrGpuResource.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrGpuResourceRef.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrInOrderDrawBuffer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrInvariantOutput.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrLayerCache.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrLayerHoister.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrMemoryPool.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrOptDrawState.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrOvalRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrPaint.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrPath.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrPathRange.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrPathRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrPathRendererChain.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrPathRendering.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrPathUtils.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrProcessor.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrProcOptInfo.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrProgramElement.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrRecordReplaceDraw.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrRectanizer_pow2.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrRectanizer_skyline.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrReducedClip.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrRenderTarget.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrResourceCache2.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrSoftwarePathRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrStencil.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrStencilAndCoverPathRenderer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrStencilAndCoverTextContext.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrStencilBuffer.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrSurface.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrSWMaskHelper.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrTest.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrTextContext.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrTexture.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrTextureAccess.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/GrTraceMarker.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/SkGpuDevice.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/SkGr.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/SkGrPixelRef.cpp \
	$(OSMAND_SKIA_RELATIVE)/src/gpu/SkGrTexturePixelRef.cpp \
