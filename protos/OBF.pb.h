...
class OsmAndRoutingIndex_RouteBorderBox : public ::google::protobuf::Message {
 public:
  ...
  inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine& borderlines(int index) const;
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine* mutable_borderlines(int index);
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine* add_borderlines();
  inline const ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine >&
      borderlines() const;
  inline ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine >*
      mutable_borderlines();
  ...
  inline void clear_blocks();
  static const int kBlocksFieldNumber = 7;
  inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock& blocks(int index) const;
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock* mutable_blocks(int index);
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock* add_blocks();
  inline const ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock >&
      blocks() const;
  inline ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock >*
      mutable_blocks();
 ...
 private:
  ...
  ::OsmAnd::OBF::OsmAndTileBox* boundaries_;
  ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine > borderlines_;
  ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock > blocks_;
...
class OsmAndRoutingIndex_RouteBorderPointsBlock : public ::google::protobuf::Message {
 public:
  ...
  inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint& points(int index) const;
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint* mutable_points(int index);
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint* add_points();
  inline const ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint >&
      points() const;
  inline ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint >*
      mutable_points();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint > points_;
...
class OsmAndRoutingIndex : public ::google::protobuf::Message {
 public:
  ...
  inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox& borderbox() const;
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* mutable_borderbox();
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* release_borderbox();
  inline void set_allocated_borderbox(::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* borderbox);
  ...
  inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox& baseborderbox() const;
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* mutable_baseborderbox();
  inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* release_baseborderbox();
  inline void set_allocated_baseborderbox(::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* baseborderbox);
 ...
 private:
  ...
  ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* borderbox_;
  ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* baseborderbox_;
...
inline const ::OsmAnd::OBF::OsmAndTileBox& OsmAndRoutingIndex_RouteBorderBox::boundaries() const {
  return boundaries_ != NULL ? *boundaries_ : *default_instance_->boundaries_;
}
inline ::OsmAnd::OBF::OsmAndTileBox* OsmAndRoutingIndex_RouteBorderBox::mutable_boundaries() {
  set_has_boundaries();
  if (boundaries_ == NULL) boundaries_ = new ::OsmAnd::OBF::OsmAndTileBox;
  return boundaries_;
}
inline ::OsmAnd::OBF::OsmAndTileBox* OsmAndRoutingIndex_RouteBorderBox::release_boundaries() {
  clear_has_boundaries();
  ::OsmAnd::OBF::OsmAndTileBox* temp = boundaries_;
  boundaries_ = NULL;
  return temp;
}
inline void OsmAndRoutingIndex_RouteBorderBox::set_allocated_boundaries(::OsmAnd::OBF::OsmAndTileBox* boundaries) {
  delete boundaries_;
  boundaries_ = boundaries;
  if (boundaries) {
    set_has_boundaries();
...
inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine& OsmAndRoutingIndex_RouteBorderBox::borderlines(int index) const {
  return borderlines_.Get(index);
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine* OsmAndRoutingIndex_RouteBorderBox::mutable_borderlines(int index) {
  return borderlines_.Mutable(index);
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderLine* OsmAndRoutingIndex_RouteBorderBox::add_borderlines() {
...
inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock& OsmAndRoutingIndex_RouteBorderBox::blocks(int index) const {
  return blocks_.Get(index);
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock* OsmAndRoutingIndex_RouteBorderBox::mutable_blocks(int index) {
  return blocks_.Mutable(index);
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock* OsmAndRoutingIndex_RouteBorderBox::add_blocks() {
  return blocks_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPointsBlock >&
...
inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint& OsmAndRoutingIndex_RouteBorderPointsBlock::points(int index) const {
  return points_.Get(index);
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint* OsmAndRoutingIndex_RouteBorderPointsBlock::mutable_points(int index) {
  return points_.Mutable(index);
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint* OsmAndRoutingIndex_RouteBorderPointsBlock::add_points() {
  return points_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderPoint >&
...
inline void OsmAndRoutingIndex_RouteBorderPoint::set_allocated_types(::std::string* types) {
  if (types_ != &::google::protobuf::internal::kEmptyString) {
    delete types_;
  }
  if (types) {
...
inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox& OsmAndRoutingIndex::borderbox() const {
  return borderbox_ != NULL ? *borderbox_ : *default_instance_->borderbox_;
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* OsmAndRoutingIndex::mutable_borderbox() {
  set_has_borderbox();
  if (borderbox_ == NULL) borderbox_ = new ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox;
  return borderbox_;
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* OsmAndRoutingIndex::release_borderbox() {
  clear_has_borderbox();
  ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* temp = borderbox_;
  borderbox_ = NULL;
  return temp;
}
inline void OsmAndRoutingIndex::set_allocated_borderbox(::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* borderbox) {
  delete borderbox_;
  borderbox_ = borderbox;
  if (borderbox) {
    set_has_borderbox();
  } else {
    clear_has_borderbox();
...
inline const ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox& OsmAndRoutingIndex::baseborderbox() const {
  return baseborderbox_ != NULL ? *baseborderbox_ : *default_instance_->baseborderbox_;
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* OsmAndRoutingIndex::mutable_baseborderbox() {
  set_has_baseborderbox();
  if (baseborderbox_ == NULL) baseborderbox_ = new ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox;
  return baseborderbox_;
}
inline ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* OsmAndRoutingIndex::release_baseborderbox() {
  clear_has_baseborderbox();
  ::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* temp = baseborderbox_;
  baseborderbox_ = NULL;
  return temp;
}
inline void OsmAndRoutingIndex::set_allocated_baseborderbox(::OsmAnd::OBF::OsmAndRoutingIndex_RouteBorderBox* baseborderbox) {
  delete baseborderbox_;
  baseborderbox_ = baseborderbox;
  if (baseborderbox) {
    set_has_baseborderbox();
  } else {
    clear_has_baseborderbox();
