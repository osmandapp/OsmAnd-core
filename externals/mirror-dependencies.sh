...
# finish upgrade to expat 2.1.0 -> 2.3.0!
download "https://sourceforge.net/projects/expat/files/expat/2.4.1/expat-2.4.1.tar.gz/download" "$DEPENDENCIES_MIRROR/expat-2.4.1.tar.gz"
