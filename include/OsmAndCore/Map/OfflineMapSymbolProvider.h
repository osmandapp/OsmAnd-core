 ...
 */
#ifndef __OFFLINE_MAP_SYMBOL_PROVIDER_H_
#define __OFFLINE_MAP_SYMBOL_PROVIDER_H_
...
namespace OsmAnd {
    ...
    public:
        ...
        virtual bool obtainSymbols(const TileId tileId, const ZoomLevel zoom,
...
#endif // __OFFLINE_MAP_SYMBOL_PROVIDER_H_
