#ifndef _OSMAND_CORE_MAP_RASTER_LAYER_PROVIDER_METRICS_H_
#define _OSMAND_CORE_MAP_RASTER_LAYER_PROVIDER_METRICS_H_
...
namespace OsmAnd
{
    namespace MapRasterLayerProvider_Metrics
    {
#define OsmAnd__MapRasterLayerProvider_Metrics__Metric_obtainData__FIELDS(FIELD_ACTION)                 \
        /* Total elapsed time */                                                                        \
...
#endif // !defined(_OSMAND_CORE_MAP_RASTER_LAYER_PROVIDER_METRICS_H_)
