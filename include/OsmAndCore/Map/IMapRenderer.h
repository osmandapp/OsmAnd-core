...
namespace OsmAnd
{
    ...
    public:
        ...
        virtual QString getGpuMemoryStats() const = 0;
        ...
        virtual void getGridConfiguration(GridConfiguration* gridConfiguration) const = 0;
        virtual ZoomLevel getVisibleArea(AreaI* visibleBBoxShifted, PointI* target31) const = 0;
        ...
        virtual bool setViewportShift(int x, int y, bool forcedUpdate = false) = 0;
        ...
        virtual float getMinZoomLevel() const = 0;
        virtual float getMaxZoomLevel() const = 0;
        ...
        virtual ZoomLevel getDetailedZoomLevel() const = 0;
