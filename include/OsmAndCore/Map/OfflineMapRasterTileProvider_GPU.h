 ...
 */
#ifndef __OFFLINE_MAP_RASTER_TILE_PROVIDER_GPU_H_
#define __OFFLINE_MAP_RASTER_TILE_PROVIDER_GPU_H_
...
namespace OsmAnd {
    ...
    protected:
    public:
        OfflineMapRasterTileProvider_GPU(const std::shared_ptr<OfflineMapDataProvider>& dataProvider, const float& displayDensity);
...
#endif // __OFFLINE_MAP_RASTER_TILE_PROVIDER_GPU_H_
