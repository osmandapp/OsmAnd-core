...
QList<OsmAnd::ArchiveReader::Item> OsmAnd::ArchiveReader::getItems(bool* const ok /*= nullptr*/, const bool isLive) const
{
    return _p->getItems(ok, isLive);
}
...
bool OsmAnd::ArchiveReader::extractItemToFile(const QString& itemName, const QString& fileName, const bool isLive, uint64_t* const extractedBytes /*= nullptr*/) const
{
    return _p->extractItemToFile(itemName, fileName, extractedBytes, isLive);
}
