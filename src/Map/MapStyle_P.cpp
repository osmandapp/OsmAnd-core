...
{
#define REGISTER_BUILTINT_VALUE_DEF(name) registerBuiltinValueDefinition(MapStyle::builtinValueDefinitions.name)
    REGISTER_BUILTINT_VALUE_DEF(INPUT_TEST);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_TEXT_LENGTH);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_TAG);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_VALUE);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_MINZOOM);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_MAXZOOM);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_NIGHT_MODE);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_LAYER);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_POINT);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_AREA);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_CYCLE);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_NAME_TAG);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_NAME_TAG2);
    REGISTER_BUILTINT_VALUE_DEF(INPUT_ADDITIONAL);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_SHIELD);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_SHADOW_RADIUS);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_SHADOW_COLOR);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_SHADER);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_CAP_3);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_CAP_2);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_CAP);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_CAP_0);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_CAP__1);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_PATH_EFFECT_3);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_PATH_EFFECT_2);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_PATH_EFFECT);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_PATH_EFFECT_0);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_PATH_EFFECT__1);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_STROKE_WIDTH_3);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_STROKE_WIDTH_2);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_STROKE_WIDTH);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_STROKE_WIDTH_0);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_STROKE_WIDTH__1);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_COLOR_3);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_COLOR);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_COLOR_2);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_COLOR_0);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_COLOR__1);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_BOLD);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_ORDER);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_MIN_DISTANCE);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_ON_PATH);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_ICON);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_ICON_ORDER);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_ORDER);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_SHADOW_LEVEL);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_DY);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_SIZE);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_COLOR);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_HALO_RADIUS);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_TEXT_WRAP_WIDTH);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_OBJECT_TYPE);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_ATTR_INT_VALUE);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_ATTR_COLOR_VALUE);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_ATTR_BOOL_VALUE);
    REGISTER_BUILTINT_VALUE_DEF(OUTPUT_ATTR_STRING_VALUE);
#undef REGISTER_BUILTINT_VALUE_DEF
}
...
bool OsmAnd::MapStyle_P::mergeInheritedAttributes()
{
    ...
    for(auto itParentAttribute = _parent->_d->_attributes.begin(); itParentAttribute != _parent->_d->_attributes.end(); ++itParentAttribute)
    {
