...
namespace OsmAnd {
    ...
    public:
        ...
        virtual uint32_t getTileTextureFormat(const std::shared_ptr< MapTile >& tile);
        virtual void allocateTexture2D(GLenum target, GLsizei levels, GLsizei width, GLsizei height, const std::shared_ptr< MapTile >& forTile);
