...
//    const std::shared_ptr<const MapSymbolsGroup::AdditionalSymbolInstanceParameters>& symbolInstanceParameters_,
...
//            return;
//
//        const auto symbolInstanceParameters = std::static_pointer_cast<const MapSymbolsGroup::AdditionalOnPathSymbolInstanceParameters>(symbolInstanceParameters_);
//        obtainRenderablesFromOnPathSymbol(
//            group,
//            onPathMapSymbol,
//            symbolInstanceParameters,
//            referenceOrigins,
...
//            return;
//
//        const auto symbolInstanceParameters = std::static_pointer_cast<const MapSymbolsGroup::AdditionalOnSurfaceSymbolInstanceParameters>(symbolInstanceParameters_);
...
//            return;
//
//        const auto symbolInstanceParameters = std::static_pointer_cast<const MapSymbolsGroup::AdditionalBillboardSymbolInstanceParameters>(symbolInstanceParameters_);
...
//        (symbolInstanceParameters && symbolInstanceParameters->overridesPinPointOnPath)
//        ? symbolInstanceParameters->pinPointOnPath
