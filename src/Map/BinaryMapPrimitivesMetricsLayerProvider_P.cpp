...
OsmAnd::BinaryMapPrimitivesMetricsLayerProvider_P::BinaryMapPrimitivesMetricsLayerProvider_P(BinaryMapPrimitivesMetricsLayerProvider* const owner_)
    : owner(owner_)
{
}

OsmAnd::BinaryMapPrimitivesMetricsLayerProvider_P::~BinaryMapPrimitivesMetricsLayerProvider_P()
{
}

bool OsmAnd::BinaryMapPrimitivesMetricsLayerProvider_P::obtainData(
    const TileId tileId,
    ...
    const IQueryController* const queryController)
{
    ...
    outTiledData.reset(new BinaryMapPrimitivesMetricsLayerProvider::Data(
        tileId,
        zoom,
...
OsmAnd::ZoomLevel OsmAnd::BinaryMapPrimitivesMetricsLayerProvider_P::getMinZoom() const
{
    return MinZoomLevel;
}

OsmAnd::ZoomLevel OsmAnd::BinaryMapPrimitivesMetricsLayerProvider_P::getMaxZoom() const
{
    return MaxZoomLevel;
}

OsmAnd::BinaryMapPrimitivesMetricsLayerProvider_P::RetainableCacheMetadata::RetainableCacheMetadata(
