...
OsmAnd::MapTiledCollectionProvider::MapTiledCollectionProvider(const int baseOrder_,
...
OsmAnd::PointI OsmAnd::MapTiledCollectionProvider::getPoint31(const int index) const
{
    OsmAnd::PointI point;
    return point;
}

int OsmAnd::MapTiledCollectionProvider::getPointsCount() const
{
    return 0;
}


sk_sp<SkImage> OsmAnd::MapTiledCollectionProvider::getImageBitmap(const int index, bool isFullSize)
{
    sk_sp<SkImage> skImage;
    return skImage;
}

QString OsmAnd::MapTiledCollectionProvider::getCaption(const int index) const
{
    QString string;
    return string;
}

OsmAnd::ZoomLevel OsmAnd::MapTiledCollectionProvider::getMinZoom() const
{
    return ZoomLevel::ZoomLevel0;
}

OsmAnd::ZoomLevel OsmAnd::MapTiledCollectionProvider::getMaxZoom() const
{
    return ZoomLevel::ZoomLevel0;
}

OsmAnd::MapTiledCollectionProvider * OsmAnd::MapTiledCollectionProvider::new_MapTiledCollectionProvider(const int baseOrder,
                                                             ...
                                                             const double scale)
{
    return new MapTiledCollectionProvider(baseOrder, hiddenPoints, showCaptions, captionStyle, captionTopSpace, referenceTileSizeOnScreenInPixels, scale);
}
...
uint32_t OsmAnd::MapTiledCollectionProvider::getTileId(const OsmAnd::AreaI& bbox31, const OsmAnd::PointI& point)
{
...
bool OsmAnd::MapTiledCollectionProvider::intersects(CollectionQuadTree& boundIntersections, double x, double y, double width, double height)
{
...
QList<std::shared_ptr<OsmAnd::MapSymbolsGroup>> OsmAnd::MapTiledCollectionProvider::buildMapSymbolsGroups(const OsmAnd::TileId tileId, const OsmAnd::ZoomLevel zoom, double scale)
{
...
bool OsmAnd::MapTiledCollectionProvider::obtainData(const IMapDataProvider::Request& request,
    std::shared_ptr<IMapDataProvider::Data>& outData,
    std::shared_ptr<OsmAnd::Metric>* const pOutMetric)
{
    const auto& req = OsmAnd::MapDataProviderHelpers::castRequest<MapTiledCollectionProvider::Request>(request);
    if (pOutMetric)
        pOutMetric->reset();
    ...
    const auto mapSymbolsGroups = buildMapSymbolsGroups(tileId, zoom, scale);
...
void OsmAnd::MapTiledCollectionProvider::obtainDataAsync(const IMapDataProvider::Request& request,
...
OsmAnd::MapTiledCollectionProvider::Data::Data(const OsmAnd::TileId tileId_,
