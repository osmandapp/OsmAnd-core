...
QString OsmAnd::MapPrimitiviser_Metrics::Metric_primitivise::toString(const bool shortFormat /*= false*/, const QString& prefix /*= QString::null*/) const
{
    QString output;
...
QString OsmAnd::MapPrimitiviser_Metrics::Metric_primitiviseAllMapObjects::toString(const bool shortFormat /*= false*/, const QString& prefix /*= QString::null*/) const
{
    QString output;
...
QString OsmAnd::MapPrimitiviser_Metrics::Metric_primitiviseWithoutSurface::toString(const bool shortFormat /*= false*/, const QString& prefix /*= QString::null*/) const
{
    QString output;
...
QString OsmAnd::MapPrimitiviser_Metrics::Metric_primitiviseWithSurface::toString(const bool shortFormat /*= false*/, const QString& prefix /*= QString::null*/) const
{
    QString output;
