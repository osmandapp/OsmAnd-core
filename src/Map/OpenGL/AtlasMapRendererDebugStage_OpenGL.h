...
namespace OsmAnd
{
    ...
    protected:
        ...
        bool renderRects2D();
        bool releaseRects2D(const bool contextLost);
        ...
        bool renderLines2D();
        bool releaseLines2D(const bool contextLost);
        ...
        bool renderLines3D();
        bool releaseLines3D(const bool contextLost);
        ...
        bool renderQuads3D();
        bool releaseQuads3D(const bool contextLost);
    public:
