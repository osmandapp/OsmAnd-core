    ...
    RasterLayerTileProgram& outRasterLayerTileProgram)
{
    ...
    const auto& fragmentShader = QString::fromLatin1(
        ...
        "#endif // TEXTURE_LOD_SUPPORTED                                                                                    ""\n"
        "    lowp float dummy =                                                                                             ""\n"
        "        param_fs_rasterTileLayer_0.dummy0 +                                                                        ""\n"
        "        param_fs_rasterTileLayer_0.dummy1 +                                                                        ""\n"
        "        param_fs_rasterTileLayer_0.dummy2 +                                                                        ""\n"
        "        param_fs_rasterTileLayer_0.dummy3 +                                                                        ""\n"
        "        param_fs_rasterTileLayer_0.dummy4 +                                                                        ""\n"
        "        param_fs_rasterTileLayer_0.dummy5 +                                                                        ""\n"
        "        param_fs_rasterTileLayer_0.dummy6 +                                                                        ""\n"
        "        param_fs_rasterTileLayer_0.dummy7;                                                                         ""\n"
        "    addExtraAlpha(finalColor, param_fs_rasterTileLayer_0.opacityFactor + 0.0001 * dummy,                                            ""\n"
