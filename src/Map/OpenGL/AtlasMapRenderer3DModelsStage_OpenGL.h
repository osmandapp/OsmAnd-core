...
namespace OsmAnd
{
    ...
    private:
        ...
        QVector<float> getHeightOfPointsOnSegment(const glm::vec2& start, const glm::vec2& end) const;
        float getPointInWorldHeight(const glm::vec2& positionInWorld) const;
        void addDebugLines(
