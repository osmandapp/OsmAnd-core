...
bool OsmAnd::AtlasMapRendererSymbolsStage_OpenGL::initializeOnPath2D()
{
    ...
    _onPathSymbol2dMaxGlyphsPerDrawCall =
        (gpuAPI->maxVertexUniformVectors - 4 /*param_vs_mOrthographicProjection*/ - 4 /*param_vs_glyphHeight*/ - 4 /*param_vs_distanceFromCamera*/ ) / 5;
...
bool OsmAnd::AtlasMapRendererSymbolsStage_OpenGL::initializeOnPath3D()
{
    ...
    _onPathSymbol3dMaxGlyphsPerDrawCall =
        (gpuAPI->maxVertexUniformVectors - 4 /*param_vs_mPerspectiveProjectionView*/ - 4 /*param_vs_glyphHeight*/ - 4 /*param_vs_zDistanceFromCamera*/) / 5;
