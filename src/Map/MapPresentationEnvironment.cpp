...
OsmAnd::LayeredIconData OsmAnd::MapPresentationEnvironment::getLayeredIconData(
    const QString& tag,
    const QString& value,
...
OsmAnd::IconData OsmAnd::MapPresentationEnvironment::getIconData(const QString& name) const
{
    return _p->getIconData(name);
}

OsmAnd::IconData OsmAnd::MapPresentationEnvironment::getMapIconData(const QString& name) const
{
    return _p->getMapIconData(name);
}

OsmAnd::IconData OsmAnd::MapPresentationEnvironment::getShaderOrShieldData(const QString& name) const
{
