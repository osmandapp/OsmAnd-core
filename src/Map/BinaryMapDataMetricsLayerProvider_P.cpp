...
OsmAnd::BinaryMapDataMetricsLayerProvider_P::BinaryMapDataMetricsLayerProvider_P(BinaryMapDataMetricsLayerProvider* const owner_)
    : owner(owner_)
{
}

OsmAnd::BinaryMapDataMetricsLayerProvider_P::~BinaryMapDataMetricsLayerProvider_P()
{
}

bool OsmAnd::BinaryMapDataMetricsLayerProvider_P::obtainData(
    const TileId tileId,
    ...
    const IQueryController* const queryController)
{
    ...
    std::shared_ptr<BinaryMapDataProvider::Data> binaryData;
    ...
    outTiledData.reset(new BinaryMapDataMetricsLayerProvider::Data(
        tileId,
        zoom,
...
OsmAnd::ZoomLevel OsmAnd::BinaryMapDataMetricsLayerProvider_P::getMinZoom() const
{
    return MinZoomLevel;
}

OsmAnd::ZoomLevel OsmAnd::BinaryMapDataMetricsLayerProvider_P::getMaxZoom() const
{
    return MaxZoomLevel;
}

OsmAnd::BinaryMapDataMetricsLayerProvider_P::RetainableCacheMetadata::RetainableCacheMetadata(
