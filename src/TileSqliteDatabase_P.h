...
namespace OsmAnd
{
    ...
    protected:
        ...
        static bool execStatement(const std::shared_ptr<sqlite3>& db, QString sql, bool suppressError = false);
    ...
    public:
        ...
        bool updateTileTimestamp(TileId tileId, ZoomLevel zoom, int64_t specification, int64_t timestamp);
