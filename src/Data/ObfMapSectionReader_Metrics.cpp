...
QString OsmAnd::ObfMapSectionReader_Metrics::Metric_loadMapObjects::toString(const QString& prefix /*= QString::null*/) const
{
    ...
    output += prefix + QString(QLatin1String("mapObjectsBlocksProcessed = %1\n")).arg(mapObjectsBlocksProcessed);
    ...
    output += prefix + QString(QLatin1String("notSkippedMapObjectsPoints = %1")).arg(notSkippedMapObjectsPoints);
