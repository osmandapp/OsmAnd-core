...
jfield jfield_NativeTransportResult_segments = NULL;
jfield jfield_NativeTransportResult_finishWalkDist = NULL;
jfield jfield_NativeTransportResult_routeTime = NULL;
